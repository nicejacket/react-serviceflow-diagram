...
var RaphaelBaseElement_1 = __webpack_require__(5);
var RaphaelBasePath = (function (_super) {
    __extends(RaphaelBasePath, _super);
    function RaphaelBasePath() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.element = null;
        return _this;
    }
    RaphaelBasePath.prototype.getElement = function () {
        return this.element.getElement();
    };
    RaphaelBasePath.prototype.render = function () {
        var _this = this;
        return (React.createElement(RaphaelBaseElement_1.RaphaelBaseElement, __assign({ id: this.props.id, ref: function (node) { _this.element = node; }, type: "path" }, this.props)));
    };
    RaphaelBasePath.defaultProps = {
        stroke: '#000',
        strokeWidth: 1,
    };
    return RaphaelBasePath;
}(React.Component));
exports.RaphaelBasePath = RaphaelBasePath;
...
var RaphaelBaseSet_1 = __webpack_require__(4);
...
var Tooltip = (function (_super) {
    ...
    Tooltip.prototype.render = function () {
        ...
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, { ref: function (node) { _this.root = node; } },
...
var RaphaelBaseSet = (function (_super) {
    __extends(RaphaelBaseSet, _super);
    function RaphaelBaseSet(props) {
    ...
    RaphaelBaseSet.prototype.componentDidMount = function () {
    ...
    RaphaelBaseSet.prototype.getSet = function () {
        return this.set;
    };
    RaphaelBaseSet.prototype.handleLoad = function (set) {
        if (this.props.load) {
            this.props.load(set);
        }
    };
    RaphaelBaseSet.prototype.componentWillUnmout = function () {
        Utils_1.removeSet(this.set);
    };
    RaphaelBaseSet.prototype.render = function () {
...
exports.RaphaelBaseSet = RaphaelBaseSet;
...
var ReactDOM = __webpack_require__(10);
var Utils_1 = __webpack_require__(14);
var RaphaelBaseElement = (function (_super) {
    __extends(RaphaelBaseElement, _super);
    function RaphaelBaseElement(props) {
        var _this = _super.call(this, props) || this;
        _this.element = null;
        _this.state = {
            loaded: false
    ...
    RaphaelBaseElement.prototype.componentDidMount = function () {
    ...
    RaphaelBaseElement.prototype.componentDidUpdate = function () {
        Utils_1.updateElement(this.element, this.props.type, this.props, this.handleUpdate.bind(this));
    };
    RaphaelBaseElement.prototype.componentWillUnmount = function () {
        Utils_1.removeElement(this.element);
    };
    RaphaelBaseElement.prototype.getElement = function () {
        return this.element;
    };
    RaphaelBaseElement.prototype.handleLoad = function (element) {
        if (this.props.load) {
            this.props.load(element);
        }
    };
    RaphaelBaseElement.prototype.handleUpdate = function (element) {
        if (this.props.update) {
            this.props.update(element);
        }
    };
    RaphaelBaseElement.prototype.render = function () {
        if (this.state.loaded)
            return null;
...
exports.RaphaelBaseElement = RaphaelBaseElement;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelBaseCircle_1 = __webpack_require__(16);
var RaphaelIconCircle = (function (_super) {
    ...
    RaphaelIconCircle.prototype.render = function () {
        ...
        return (React.createElement(RaphaelBaseCircle_1.RaphaelBaseCircle, __assign({ id: id, x: x, y: y, r: radius }, others)));
    };
...
var React = __webpack_require__(0);
var RaphaelBaseElement_1 = __webpack_require__(5);
var RaphaelBaseRect = (function (_super) {
    __extends(RaphaelBaseRect, _super);
    function RaphaelBaseRect() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.element = null;
        return _this;
    }
    RaphaelBaseRect.prototype.getElement = function () {
        return this.element.getElement();
    };
    RaphaelBaseRect.prototype.render = function () {
        var _this = this;
        return (React.createElement(RaphaelBaseElement_1.RaphaelBaseElement, __assign({ ref: function (node) { _this.element = node; }, type: "rect" }, this.props)));
    };
    RaphaelBaseRect.defaultProps = {
        x: 0,
        y: 0,
        width: 80,
        height: 32,
    ...
    return RaphaelBaseRect;
}(React.Component));
exports.RaphaelBaseRect = RaphaelBaseRect;
...
var RaphaelBaseRect_1 = __webpack_require__(7);
var RaphaelBaseMultilineText_1 = __webpack_require__(20);
...
var Task = (function (_super) {
    ...
    Task.prototype.render = function () {
        ...
        return (React.createElement(Tooltip_1.default, { data: data },
            React.createElement(RaphaelBaseRect_1.RaphaelBaseRect, { id: data.id, x: x, y: y, width: width, height: height, r: radius, stroke: stroke, strokeWidth: strokeWidth, fill: fill, fillOpacity: fillOpacity }),
            React.createElement(RaphaelBaseMultilineText_1.RaphaelBaseMultilineText, { x: x + width / 2, y: y + height / 2, color: stroke, text: text, width: width }),
...
var React = __webpack_require__(0);
var RaphaelBaseElement_1 = __webpack_require__(5);
var RaphaelBaseText = (function (_super) {
    __extends(RaphaelBaseText, _super);
    function RaphaelBaseText() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.element = null;
        return _this;
    }
    RaphaelBaseText.prototype.getElement = function () {
        return this.element.getElement();
    };
    RaphaelBaseText.prototype.render = function () {
        var _this = this;
        return (React.createElement(RaphaelBaseElement_1.RaphaelBaseElement, __assign({ ref: function (node) { _this.element = node; }, type: "text" }, this.props)));
    };
    RaphaelBaseText.defaultProps = {
        x: 0,
        y: 0,
        text: '',
    };
...
exports.RaphaelBaseText = RaphaelBaseText;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var DiagramIconTimer_1 = __webpack_require__(38);
var DiagramIconError_1 = __webpack_require__(42);
var DiagramIconSignal_1 = __webpack_require__(44);
var DiagramIconMessage_1 = __webpack_require__(46);
var DiagramIconCompensate_1 = __webpack_require__(48);
...
var Tooltip_1 = __webpack_require__(3);
var DiagramColorService_1 = __webpack_require__(2);
var RaphaelBaseRhombus_1 = __webpack_require__(18);
var Gateway = (function (_super) {
    ...
    Gateway.prototype.render = function () {
        ...
        return (React.createElement(Tooltip_1.default, { data: data },
            React.createElement(RaphaelBaseRhombus_1.RaphaelBaseRhombus, { id: data.id, x: x, y: y, width: width, height: height, stroke: DiagramColorService_1.getBpmnColor(data, DiagramColorService_1.MAIN_STROKE_COLOR), strokeWidth: strokeWidth, fill: DiagramColorService_1.getFillColour(data.id), fillOpacity: DiagramColorService_1.getFillOpacity() }),
            this.props.children));
    };
...
var RaphaelBasePaper = (function (_super) {
    __extends(RaphaelBasePaper, _super);
    function RaphaelBasePaper(props) {
        var _this = _super.call(this, props) || this;
        _this.paper = null;
    ...
    RaphaelBasePaper.prototype.componentDidMount = function () {
    ...
    RaphaelBasePaper.prototype.componentDidUpdate = function () {
        Utils_1.updatePaper(this.paper, this.props);
    };
    RaphaelBasePaper.prototype.componentWillUnmount = function () {
        this.paper.remove();
    };
    RaphaelBasePaper.prototype.getPaper = function () {
        return this.paper;
    };
    RaphaelBasePaper.prototype.genElementsContainer = function () {
        if (this.state.loaded) {
    ...
    RaphaelBasePaper.prototype.render = function () {
        var _this = this;
...
exports.RaphaelBasePaper = RaphaelBasePaper;
...
Object.defineProperty(exports, "__esModule", { value: true });
var Raphael = __webpack_require__(15);
var PAPERS = [];
var ELEMENTS = [];
...
var React = __webpack_require__(0);
var RaphaelBaseElement_1 = __webpack_require__(5);
var RaphaelBaseCircle = (function (_super) {
    __extends(RaphaelBaseCircle, _super);
    function RaphaelBaseCircle() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.element = null;
        return _this;
    }
    RaphaelBaseCircle.prototype.getElement = function () {
        return this.element.getElement();
    };
    RaphaelBaseCircle.prototype.render = function () {
        var _this = this;
        return (React.createElement(RaphaelBaseElement_1.RaphaelBaseElement, __assign({ id: this.props.id, ref: function (node) { _this.element = node; }, type: "circle" }, this.props)));
    };
    RaphaelBaseCircle.defaultProps = {
        x: 0,
        y: 0,
        r: 10,
    };
...
exports.RaphaelBaseCircle = RaphaelBaseCircle;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelBasePath_1 = __webpack_require__(1);
...
var RaphaelBaseArrowLeft = (function (_super) {
    __extends(RaphaelBaseArrowLeft, _super);
    function RaphaelBaseArrowLeft() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RaphaelBaseArrowLeft.prototype.render = function () {
        return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, __assign({ d: PATH }, this.props)));
    };
    return RaphaelBaseArrowLeft;
}(React.Component));
exports.RaphaelBaseArrowLeft = RaphaelBaseArrowLeft;
...
var React = __webpack_require__(0);
var RaphaelBasePath_1 = __webpack_require__(1);
var RaphaelBaseRhombus = (function (_super) {
    __extends(RaphaelBaseRhombus, _super);
    function RaphaelBaseRhombus() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RaphaelBaseRhombus.prototype.render = function () {
        ...
        var PATH = 'M' + x + ' ' + (y + (height / 2)) +
            ...
            'L' + (x + (width / 2)) + ' ' + y + 'z';
        return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { id: id, d: PATH, stroke: stroke, strokeWidth: strokeWidth, fill: fill, fillOpacity: fillOpacity }));
    };
    RaphaelBaseRhombus.defaultProps = {
        x: 0,
        y: 0,
    };
    return RaphaelBaseRhombus;
}(React.Component));
exports.RaphaelBaseRhombus = RaphaelBaseRhombus;
...
var RaphaelBasePentagon = (function (_super) {
    __extends(RaphaelBasePentagon, _super);
    function RaphaelBasePentagon() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RaphaelBasePentagon.prototype.render = function () {
        var _a = this.props, x = _a.x, y = _a.y;
        return React.createElement(RaphaelBasePath_1.RaphaelBasePath, { d: PATH, transform: "T" + (x + 4) + ", " + (y + 4) });
    };
    RaphaelBasePentagon.defaultProps = {
        x: 0,
        y: 0,
        strokeLinejoin: 'bevel',
    };
    return RaphaelBasePentagon;
}(React.Component));
exports.RaphaelBasePentagon = RaphaelBasePentagon;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelBaseText_1 = __webpack_require__(9);
var TEXT_PADDING = 3;
var RaphaelBaseMultilineText = (function (_super) {
    __extends(RaphaelBaseMultilineText, _super);
    function RaphaelBaseMultilineText(props) {
        var _this = _super.call(this, props) || this;
    ...
    RaphaelBaseMultilineText.prototype.componentDidMount = function () {
        var formattedText = this.formatText();
        this.setState({ text: formattedText });
    };
    RaphaelBaseMultilineText.prototype.render = function () {
        var _this = this;
        var _a = this.props, x = _a.x, y = _a.y, color = _a.color, transform = _a.transform;
        return (React.createElement(RaphaelBaseText_1.RaphaelBaseText, { ref: function (node) { _this.textPaper = node; }, text: this.state.text, x: x + TEXT_PADDING, y: y + TEXT_PADDING, fill: color, fontSize: 11, fontFamily: "Arial", textAnchor: "middle", transform: transform }));
    };
    RaphaelBaseMultilineText.defaultProps = {
        x: 0,
        y: 0,
        color: '#373e48',
    };
    return RaphaelBaseMultilineText;
}(React.Component));
exports.RaphaelBaseMultilineText = RaphaelBaseMultilineText;
...
var React = __webpack_require__(0);
var RaphaelBaseSet_1 = __webpack_require__(4);
var Polyline_1 = __webpack_require__(27);
var RaphaelBasePath_1 = __webpack_require__(1);
var Raphael = __webpack_require__(15);
var Utils_1 = __webpack_require__(21);
var ARROW_WIDTH = 4;
var SEQUENCEFLOW_STROKE = 2;
var RaphaelBaseFlowArrow = (function (_super) {
    __extends(RaphaelBaseFlowArrow, _super);
    function RaphaelBaseFlowArrow() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.line = null;
        _this.renderLine = function () {
            ...
            return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { id: flow.id, d: polyline.path, stroke: stroke, strokeWidth: SEQUENCEFLOW_STROKE }));
        };
        _this.renderArrow = function () {
            ...
            return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { id: _this.props.flow.id, d: arrowHead, stroke: stroke, strokeWidth: SEQUENCEFLOW_STROKE, fill: stroke, transform: transform }));
        };
        return _this;
    }
    RaphaelBaseFlowArrow.prototype.render = function () {
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, null,
            this.renderLine(),
            this.renderArrow()));
    };
    RaphaelBaseFlowArrow.defaultProps = {
        x: 0,
        y: 0,
    };
    return RaphaelBaseFlowArrow;
}(React.Component));
exports.RaphaelBaseFlowArrow = RaphaelBaseFlowArrow;
...
var ARROW_WIDTH = 4;
var SEQUENCEFLOW_STROKE = 2;
var RaphaelBaseAssociation = (function (_super) {
    __extends(RaphaelBaseAssociation, _super);
    function RaphaelBaseAssociation() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.line = null;
        _this.renderLine = function () {
            var association = _this.props.association;
            var stroke = Utils_1.getStrokeAndFill(association).stroke;
            var polyline = new Polyline_1.Polyline(association.id, association.waypoints, SEQUENCEFLOW_STROKE);
            var lastLineIndex = polyline.getLinesCount() - 1;
            _this.line = polyline.getLine(lastLineIndex);
            return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { id: association.id, d: polyline.path, stroke: stroke, strokeWidth: SEQUENCEFLOW_STROKE, strokeDasharray: ". " }));
        };
        _this.renderArrow = function () {
            var stroke = Utils_1.getStrokeAndFill(_this.props.association).stroke;
            var line = _this.line;
            var doubleArrowWidth = 2 * ARROW_WIDTH;
            var width = ARROW_WIDTH / 2 + .5;
            var arrowHead = "M0 0L-" + width + "-" + doubleArrowWidth + "L" + width + "-" + doubleArrowWidth + "z";
            var angle = Raphael.deg(line.angle - Math.PI / 2);
            var transform = "t" + line.x2 + "," + line.y2 + "r" + angle + " 0 0";
            return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { id: _this.props.association.id, d: arrowHead, stroke: stroke, strokeWidth: SEQUENCEFLOW_STROKE, fill: stroke, transform: transform }));
        };
        return _this;
    }
    RaphaelBaseAssociation.prototype.render = function () {
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, null,
            this.renderLine(),
            this.renderArrow()));
    };
    RaphaelBaseAssociation.defaultProps = {
        x: 0,
        y: 0,
    };
    return RaphaelBaseAssociation;
}(React.Component));
exports.RaphaelBaseAssociation = RaphaelBaseAssociation;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconCircle_1 = __webpack_require__(6);
var DiagramContainerIconEvent_1 = __webpack_require__(11);
var Tooltip_1 = __webpack_require__(3);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Anchor_1 = __webpack_require__(81);
/* tslint:disable */
...
var React = __webpack_require__(0);
var RaphaelBaseElement_1 = __webpack_require__(5);
var RaphaelBaseEllipse = (function (_super) {
    __extends(RaphaelBaseEllipse, _super);
    function RaphaelBaseEllipse() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.element = null;
        return _this;
    }
    RaphaelBaseEllipse.prototype.getElement = function () {
        return this.element.getElement();
    };
    RaphaelBaseEllipse.prototype.render = function () {
        var _this = this;
        return (React.createElement(RaphaelBaseElement_1.RaphaelBaseElement, __assign({ ref: function (node) { _this.element = node; }, type: "ellipse" }, this.props)));
    };
    RaphaelBaseEllipse.defaultProps = {
        x: 0,
        y: 0,
        rx: 10,
        ry: 20,
    };
    return RaphaelBaseEllipse;
}(React.Component));
exports.RaphaelBaseEllipse = RaphaelBaseEllipse;
...
var React = __webpack_require__(0);
var RaphaelBaseElement_1 = __webpack_require__(5);
var RaphaelBaseImage = (function (_super) {
    __extends(RaphaelBaseImage, _super);
    function RaphaelBaseImage() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.element = null;
        return _this;
    }
    RaphaelBaseImage.prototype.getElement = function () {
        return this.element.getElement();
    };
    RaphaelBaseImage.prototype.render = function () {
        var _this = this;
        return (React.createElement(RaphaelBaseElement_1.RaphaelBaseElement, __assign({ ref: function (node) { _this.element = node; }, type: 'image' }, this.props)));
    };
    RaphaelBaseImage.defaultProps = {
        src: '',
        x: 0,
        y: 0,
        width: 64,
...
exports.RaphaelBaseImage = RaphaelBaseImage;
...
var React = __webpack_require__(0);
var RaphaelBasePath_1 = __webpack_require__(1);
var RaphaelBaseLine = (function (_super) {
    __extends(RaphaelBaseLine, _super);
    function RaphaelBaseLine() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.path = null;
        return _this;
    }
    RaphaelBaseLine.prototype.getElement = function () {
        return this.path.getElement();
    };
    RaphaelBaseLine.prototype.render = function () {
        var _this = this;
        var _a = this.props, x1 = _a.x1, x2 = _a.x2, y1 = _a.y1, y2 = _a.y2, animate = _a.animate, attr = _a.attr, stroke = _a.stroke, strokeWidth = _a.strokeWidth;
        ...
        return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { ref: function (node) { _this.path = node; }, d: PATH, attr: attr, animate: animate, stroke: stroke, strokeWidth: strokeWidth }));
    };
    RaphaelBaseLine.defaultProps = {
        x1: 0,
        y1: 0,
        x2: 0,
        y2: 0,
    };
    return RaphaelBaseLine;
}(React.Component));
exports.RaphaelBaseLine = RaphaelBaseLine;
...
var React = __webpack_require__(0);
var RaphaelBaseElement_1 = __webpack_require__(5);
var RaphaelBasePrint = (function (_super) {
    __extends(RaphaelBasePrint, _super);
    function RaphaelBasePrint() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.element = null;
        return _this;
    }
    RaphaelBasePrint.prototype.getElement = function () {
        return this.element.getElement();
    };
    RaphaelBasePrint.prototype.render = function () {
        var _this = this;
        return (React.createElement(RaphaelBaseElement_1.RaphaelBaseElement, __assign({ ref: function (node) { _this.element = node; }, type: "print" }, this.props)));
    };
    RaphaelBasePrint.defaultProps = {
        x: 0,
        y: 0,
        text: '',
        fontFamily: 'Arial',
    };
    return RaphaelBasePrint;
}(React.Component));
exports.RaphaelBasePrint = RaphaelBasePrint;
...
Object.defineProperty(exports, "__esModule", { value: true });
var Diagram_1 = __webpack_require__(33);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelBasePaper_1 = __webpack_require__(13);
var StartEvent_1 = __webpack_require__(37);
var ExclusiveGateway_1 = __webpack_require__(50);
var InclusiveGateway_1 = __webpack_require__(52);
var EventGateway_1 = __webpack_require__(53);
var ParallelGateway_1 = __webpack_require__(54);
var EndEvent_1 = __webpack_require__(56);
var UserTask_1 = __webpack_require__(57);
var ManualTask_1 = __webpack_require__(60);
var ServiceTask_1 = __webpack_require__(63);
var ReceiveTask_1 = __webpack_require__(66);
var ScriptTask_1 = __webpack_require__(69);
var BusinessRuleTask_1 = __webpack_require__(72);
var BoundaryEvent_1 = __webpack_require__(75);
var ThrowEvent_1 = __webpack_require__(76);
var IntermediateCatchingEvent_1 = __webpack_require__(77);
var SubProcess_1 = __webpack_require__(78);
var EventSubProcess_1 = __webpack_require__(79);
var SequenceFlow_1 = __webpack_require__(80);
var Pools_1 = __webpack_require__(82);
var Association_1 = __webpack_require__(86);
...
var Diagram = (function (_super) {
    ...
    Diagram.prototype.render = function () {
        var _a = this.props.diagram, diagramBeginX = _a.diagramBeginX, diagramBeginY = _a.diagramBeginY, diagramWidth = _a.diagramWidth, diagramHeight = _a.diagramHeight, elements = _a.elements, flows = _a.flows, pools = _a.pools, associations = _a.associations;
        return (React.createElement(RaphaelBasePaper_1.RaphaelBasePaper, { x: diagramBeginX, y: diagramBeginY, width: diagramWidth + 10, height: diagramHeight, onMouseEnter: this.onMouseEnterHandler, onClick: this.props.onClick },
            ...
            associations.map(function (association) { return React.createElement(Association_1.default, { association: association }); }),
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./RaphaelBasePaper.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/dist/cjs.js!./RaphaelBasePaper.less");
...
var React = __webpack_require__(0);
var RaphaelIconCircle_1 = __webpack_require__(6);
var RaphaelIconTImer_1 = __webpack_require__(39);
var Tooltip_1 = __webpack_require__(3);
...
var RaphaelIconTimer = (function (_super) {
    ...
    RaphaelIconTimer.prototype.render = function () {
        ...
        return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { d: PATH, stroke: stroke, fill: fill, transform: "T" + x + "," + y }));
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconError_1 = __webpack_require__(43);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconSignal_1 = __webpack_require__(45);
...
var RaphaelIconSignal = (function (_super) {
    ...
    RaphaelIconSignal.prototype.render = function () {
        ...
        return React.createElement(RaphaelBasePath_1.RaphaelBasePath, __assign({ d: PATH, transform: "T" + x + "," + y }, others));
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconMessage_1 = __webpack_require__(47);
...
var RaphaelIconMessage = (function (_super) {
    ...
    RaphaelIconMessage.prototype.render = function () {
        var _a = this.props, x = _a.x, y = _a.y, stroke = _a.stroke, strokeWidth = _a.strokeWidth, fill = _a.fill, fillOpacity = _a.fillOpacity;
        return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { d: PATH, stroke: stroke, strokeWidth: strokeWidth, fill: fill, fillOpacity: fillOpacity, transform: "T" + x + "," + y }));
    };
...
var React = __webpack_require__(0);
var Tooltip_1 = __webpack_require__(3);
var RaphaelIconCompensate_1 = __webpack_require__(49);
...
var React = __webpack_require__(0);
var RaphaelBaseSet_1 = __webpack_require__(4);
var RaphaelBaseArrowLeft_1 = __webpack_require__(17);
var RaphaelIconCompensate = (function (_super) {
    ...
    RaphaelIconCompensate.prototype.render = function () {
        ...
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, null,
            React.createElement(RaphaelBaseArrowLeft_1.RaphaelBaseArrowLeft, __assign({ transform: "T" + (x - 18) + "," + (y - 11) }, others)),
            React.createElement(RaphaelBaseArrowLeft_1.RaphaelBaseArrowLeft, __assign({ transform: "T" + (x - 26) + "," + (y - 11) }, others))));
    };
...
var RaphaelIconCross_1 = __webpack_require__(51);
var DiagramColorService_1 = __webpack_require__(2);
...
var RaphaelIconCross = (function (_super) {
    ...
    RaphaelIconCross.prototype.render = function () {
        ...
        return React.createElement(RaphaelBasePath_1.RaphaelBasePath, __assign({ d: PATH }, others));
    };
...
var Gateway_1 = __webpack_require__(12);
var RaphaelIconCircle_1 = __webpack_require__(6);
var RaphaelBasePentagon_1 = __webpack_require__(19);
var DiagramColorService_1 = __webpack_require__(2);
var EventGateway = (function (_super) {
    ...
    EventGateway.prototype.render = function () {
        ...
        return (React.createElement(Gateway_1.default, { x: x, y: y, width: width, height: height, data: data },
            ...
            React.createElement(RaphaelBasePentagon_1.RaphaelBasePentagon, { x: x, y: y, stroke: stroke, strokeWidth: strokeWidth, fill: fill, fillOpacity: fillOpacity })));
    };
...
var React = __webpack_require__(0);
var Gateway_1 = __webpack_require__(12);
var RaphaelIconPlus_1 = __webpack_require__(55);
var DiagramColorService_1 = __webpack_require__(2);
...
var RaphaelIconPlus = (function (_super) {
    ...
    RaphaelIconPlus.prototype.render = function () {
        ...
        return React.createElement(RaphaelBasePath_1.RaphaelBasePath, __assign({ d: PATH }, this.props, { transform: transform }));
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var Task_1 = __webpack_require__(8);
var DiagramIconUserTask_1 = __webpack_require__(58);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconUser_1 = __webpack_require__(59);
...
var RaphaelIconUser = (function (_super) {
    ...
    RaphaelIconUser.prototype.render = function () {
        ...
        return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { d: PATH, transform: "T" + x + "," + y, fillOpacity: fillOpacity, stroke: stroke, fill: fill }));
    };
...
var React = __webpack_require__(0);
var Task_1 = __webpack_require__(8);
var DiagramIconManualTask_1 = __webpack_require__(61);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconManual_1 = __webpack_require__(62);
...
var RaphaelIconManual = (function (_super) {
    ...
    RaphaelIconManual.prototype.render = function () {
        var _a = this.props, x = _a.x, y = _a.y, stroke = _a.stroke, fill = _a.fill;
        return (React.createElement(RaphaelBasePath_1.RaphaelBasePath, { d: PATH, stroke: stroke, fill: fill, fillOpacity: 1, transform: "T" + x + "," + y }));
    };
...
var React = __webpack_require__(0);
var Task_1 = __webpack_require__(8);
var DiagramIconServiceTask_1 = __webpack_require__(64);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconService_1 = __webpack_require__(65);
...
var React = __webpack_require__(0);
var Task_1 = __webpack_require__(8);
var DiagramIconReceiveTask_1 = __webpack_require__(67);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconReceive_1 = __webpack_require__(68);
...
var React = __webpack_require__(0);
var Task_1 = __webpack_require__(8);
var DiagramIconScriptTask_1 = __webpack_require__(70);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconScript_1 = __webpack_require__(71);
...
var React = __webpack_require__(0);
var Task_1 = __webpack_require__(8);
var DiagramIconBusinessRuleTask_1 = __webpack_require__(73);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var RaphaelIconBusinessRule_1 = __webpack_require__(74);
...
var React = __webpack_require__(0);
var Tooltip_1 = __webpack_require__(3);
var RaphaelBaseFlowArrow_1 = __webpack_require__(22);
var SequenceFlow = (function (_super) {
    ...
    SequenceFlow.prototype.render = function () {
        return (React.createElement(Tooltip_1.default, { data: this.props.flow },
            React.createElement(RaphaelBaseFlowArrow_1.RaphaelBaseFlowArrow, { flow: this.props.flow })));
    };
    return SequenceFlow;
}(React.Component));
...
var React = __webpack_require__(0);
var RaphaelBaseSet_1 = __webpack_require__(4);
var Pool_1 = __webpack_require__(83);
var Lanes_1 = __webpack_require__(84);
var defaultPools = [];
var Pools = (function (_super) {
    ...
    Pools.prototype.render = function () {
        ...
        if (!pools || !pools.length)
            return null;
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, null, pools.map(function (pool, i) {
            var lanes = pool.lanes, others = __rest(pool, ["lanes"]);
            return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, { key: i },
...
var Pool = (function (_super) {
    ...
    Pool.prototype.render = function () {
        ...
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, null,
            React.createElement(RaphaelBaseRect_1.RaphaelBaseRect, { x: x, y: y, width: width, height: height, r: radius, stroke: stroke, strokeWidth: strokeWidth, fill: fill, fillOpacity: fillOpacity }),
            React.createElement(RaphaelBaseText_1.RaphaelBaseText, { x: x + 14, y: y + height / 2, text: text, transform: textTransform })));
    };
    Pool.defaultProps = {
        x: 0,
        y: 0,
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var Lane_1 = __webpack_require__(85);
var RaphaelBaseSet_1 = __webpack_require__(4);
var defaultLanes = [];
var Lanes = (function (_super) {
    ...
    Lanes.prototype.render = function () {
        ...
        if (!lanes || !lanes.length)
            return null;
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, null, this.props.lanes.map(function (lane, i) { return React.createElement(Lane_1.default, __assign({ key: i, text: lane.name }, lane)); })));
    };
    Lanes.defaultProps = {
        lanes: defaultLanes,
    };
...
var Lane = (function (_super) {
    ...
    Lane.prototype.render = function () {
        ...
        return (React.createElement(RaphaelBaseSet_1.RaphaelBaseSet, null,
            React.createElement(RaphaelBaseRect_1.RaphaelBaseRect, { x: x, y: y, width: width, height: height, r: radius, stroke: stroke, strokeWidth: strokeWidth, fill: fill, fillOpacity: fillOpacity }),
            React.createElement(RaphaelBaseText_1.RaphaelBaseText, { x: x + 10, y: y + height / 2, text: text, transform: textTransform })));
    };
    Lane.defaultProps = {
        x: 0,
        y: 0,
...
var React = __webpack_require__(0);
var Tooltip_1 = __webpack_require__(3);
var RaphaelBaseAssociation_1 = __webpack_require__(23);
var Association = (function (_super) {
    ...
    Association.prototype.render = function () {
        return (React.createElement(Tooltip_1.default, { data: this.props.association },
            React.createElement(RaphaelBaseAssociation_1.RaphaelBaseAssociation, { association: this.props.association })));
    };
    return Association;
}(React.Component));
...
var DiagramModel = (function () {
    function DiagramModel(obj) {
        ...
        if (obj) {
            ...
            if (obj.associations) {
                obj.associations.forEach(function (association) {
                    _this.associations.push(new DiagramAssociationElementModel(association));
                });
            }
        }
    }
...
var DiagramAssociationElementModel = (function () {
    function DiagramAssociationElementModel(obj) {
        var _this = this;
        this.properties = [];
        this.waypoints = [];
        if (obj) {
    ...
    return DiagramAssociationElementModel;
}());
exports.DiagramAssociationElementModel = DiagramAssociationElementModel;
...
Object.defineProperty(exports, "__esModule", { value: true });
var RaphaelBaseArrowLeft_1 = __webpack_require__(17);
exports.RaphaelBaseArrowLeft = RaphaelBaseArrowLeft_1.RaphaelBaseArrowLeft;
var RaphaelBaseAssociation_1 = __webpack_require__(23);
exports.RaphaelBaseAssociation = RaphaelBaseAssociation_1.RaphaelBaseAssociation;
var RaphaelBaseCircle_1 = __webpack_require__(16);
exports.RaphaelBaseCircle = RaphaelBaseCircle_1.RaphaelBaseCircle;
var RaphaelBaseElement_1 = __webpack_require__(5);
exports.RaphaelBaseElement = RaphaelBaseElement_1.RaphaelBaseElement;
var RaphaelBaseEllipse_1 = __webpack_require__(28);
exports.RaphaelBaseEllipse = RaphaelBaseEllipse_1.RaphaelBaseEllipse;
var RaphaelBaseFlowArrow_1 = __webpack_require__(22);
exports.RaphaelBaseFlowArrow = RaphaelBaseFlowArrow_1.RaphaelBaseFlowArrow;
var RaphaelBaseImage_1 = __webpack_require__(29);
exports.RaphaelBaseImage = RaphaelBaseImage_1.RaphaelBaseImage;
var RaphaelBaseLine_1 = __webpack_require__(30);
exports.RaphaelBaseLine = RaphaelBaseLine_1.RaphaelBaseLine;
var RaphaelBaseMultilineText_1 = __webpack_require__(20);
exports.RaphaelBaseMultilineText = RaphaelBaseMultilineText_1.RaphaelBaseMultilineText;
var RaphaelBasePaper_1 = __webpack_require__(13);
exports.RaphaelBasePaper = RaphaelBasePaper_1.RaphaelBasePaper;
var RaphaelBasePath_1 = __webpack_require__(1);
exports.RaphaelBasePath = RaphaelBasePath_1.RaphaelBasePath;
var RaphaelBasePentagon_1 = __webpack_require__(19);
exports.RaphaelBasePentagon = RaphaelBasePentagon_1.RaphaelBasePentagon;
var RaphaelBasePrint_1 = __webpack_require__(31);
exports.RaphaelBasePrint = RaphaelBasePrint_1.RaphaelBasePrint;
var RaphaelBaseRect_1 = __webpack_require__(7);
exports.RaphaelBaseRect = RaphaelBaseRect_1.RaphaelBaseRect;
var RaphaelBaseRhombus_1 = __webpack_require__(18);
exports.RaphaelBaseRhombus = RaphaelBaseRhombus_1.RaphaelBaseRhombus;
var RaphaelBaseSet_1 = __webpack_require__(4);
exports.RaphaelBaseSet = RaphaelBaseSet_1.RaphaelBaseSet;
var RaphaelBaseText_1 = __webpack_require__(9);
exports.RaphaelBaseText = RaphaelBaseText_1.RaphaelBaseText;
