...
const IMG_DATA = `data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACIAAAAjCAYAAADxG9hnAAAABmJLR0QA/wD/AP+gvaeTAAAACXBI WXMAAA7DAAAO
...
export interface IconBoxPublishProps {
  x?: number;
  y?: number;
  width?: number;
  height?: number;
...
export default class IconBoxPublish extends React.Component<IconBoxPublishProps, any> {
  render() {
    return <Image src={IMG_DATA} {...this.props} />;
  }
}
